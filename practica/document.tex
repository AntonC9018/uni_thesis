...
Fiecare segment ar avea un ID și o progresie în el.
...
Pentru mapa mea dreaptă, implementarea interfeței este foarte simplă, deoarece am un singur segment drept de drum, dar se poate imagina un sistem de drumuri băzate pe curbe Bezier care ar integra tot bine cu sistemul acesta. 
