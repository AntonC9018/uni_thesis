...
% Chapters left alighed and 14pt
\usepackage{titlesec}
...
\newcommand{\anexeCount}{24} % for now, hardcode this
...
\begin{titlepage}
  ...
  \begin{center}
      ...
      \Large
      \uppercase{\textbf\expandafter{\thesisTitle}}
      \vspace{0.75cm}
...
\chapter*{\centering Adnotare}

\textbf{la teza de licență/master ``\thesisTitle'', a studentului \authorName{}, grupa \uniGroupName{}, programul de studii \programulDeStudii.}

\textbf{Structura tezei.}
Teza constă din: Introducere, 4 capitole, Concluzii generale și recomandări, Bibliografie \bibliographyEntryCount{} de titluri.
Textul de bază cuprinde \usefulPageCount{} de pagini și \anexeCount{} anexe.

\textbf{Cuvinte-cheie:}
Generarea codului, eliminarea codului boilerplate, programarea declarativă,
...
\textbf{Rezultatele preconizate și obținute} rezumă în (1) analiza soluțiilor existente pentru generarea codului (2) implementarea nucleului generatorului de cod, (3) suportului pentru plugin-uri, (4) demonstrarea unor plugin-uri utile, (5) folosirea generatorului de cod într-un un proiect real.
...
Cel mai des, Roslyn este utilizat pentru analizori, adică programe care analizează codul sursă și detectează erori logice, posibil propunând o remediere (code fix), sau adaugând operații utile în IDE-urile, de exemplu, ``implement methods'', ``extract into a local function''.
...
Exemplu\footnote{a se vedea codul sursă pentru un exemplu complet:
...
A se vedea Anexa \ref{appendix:Kari____Kari_source_Kari_Generator_KariCompiler_21_87}.
...
\section{KariCompiler.cs, rândurile 21--87}\label{appendix:Kari____Kari_source_Kari_Generator_KariCompiler_21_87}
\inputminted[firstline=21, lastline=87]{cs}{../Kari/source/Kari.Generator/KariCompiler.cs}

\section{ArgumentParsing.cs}\label{appendix:Kari____Kari_source_Kari_Arguments_ArgumentParsing}
\inputminted{cs}{../Kari/source/Kari.Arguments/ArgumentParsing.cs}

\section{AdministratorFinder.cs}\label{appendix:Kari____Kari_source_Kari_GeneratorCore_Workflow_AdministratorFinder}
\inputminted{cs}{../Kari/source/Kari.GeneratorCore/Workflow/AdministratorFinder.cs}

\section{MasterEnvironment.cs, rândurile 285--598}\label{appendix:Kari____Kari_source_Kari_GeneratorCore_Workflow_MasterEnvironment_285_598}
\inputminted[firstline=285, lastline=598]{cs}{../Kari/source/Kari.GeneratorCore/Workflow/MasterEnvironment.cs}

\section{MasterEnvironment.cs, rândurile 604--664}\label{appendix:Kari____Kari_source_Kari_GeneratorCore_Workflow_MasterEnvironment_604_664}
\inputminted[firstline=604, lastline=664]{cs}{../Kari/source/Kari.GeneratorCore/Workflow/MasterEnvironment.cs}

\section{MasterEnvironment.cs, rândurile 666--697}\label{appendix:Kari____Kari_source_Kari_GeneratorCore_Workflow_MasterEnvironment_666_697}
\inputminted[firstline=666, lastline=697]{cs}{../Kari/source/Kari.GeneratorCore/Workflow/MasterEnvironment.cs}

\section{CodeBuilder.cs, rândurile 19--184}\label{appendix:Kari____Kari_source_Kari_Utils_CodeBuilder_19_184}
\inputminted[firstline=19, lastline=184]{cs}{../Kari/source/Kari.Utils/CodeBuilder.cs}

\section{Annotator.cs}\label{appendix:Kari____Kari_source_Kari_Annotator_Annotator}
\inputminted{cs}{../Kari/source/Kari.Annotator/Annotator.cs}

\section{InternalPlugin.props}\label{appendix:Kari____Kari_source_Kari_Plugins_InternalPlugin}
\inputminted{xml}{../Kari/source/Kari.Plugins/InternalPlugin.props}

\section{FlagsAdministrator.cs}\label{appendix:Kari____Kari_source_Kari_Plugins_Flags_FlagsAdministrator}
\inputminted{cs}{../Kari/source/Kari.Plugins/Flags/FlagsAdministrator.cs}

\section{Administrator.cs, rândurile 67--163}\label{appendix:Kari____Kari_source_Kari_GeneratorCore_Workflow_Administrator_67_163}
\inputminted[firstline=67, lastline=163]{cs}{../Kari/source/Kari.GeneratorCore/Workflow/Administrator.cs}

\section{FlagsAnalyzer.cs}\label{appendix:Kari____Kari_source_Kari_Plugins_Flags_FlagsAnalyzer}
\inputminted{cs}{../Kari/source/Kari.Plugins/Flags/FlagsAnalyzer.cs}

\section{Program.cs}\label{appendix:uni_thesis____examples_flags_Program}
\inputminted{cs}{../examples/flags/Program.cs}

\section{Flags.cs}\label{appendix:uni_thesis____examples_flags_Generated_Flags}
\inputminted{cs}{../examples/flags/Generated/Flags.cs}

\section{DataObjectAdministrator.cs}\label{appendix:Kari____Kari_source_Kari_Plugins_DataObject_DataObjectAdministrator}
\inputminted{cs}{../Kari/source/Kari.Plugins/DataObject/DataObjectAdministrator.cs}

\section{DataObjectAnalyzer.cs, rândurile 14--46}\label{appendix:Kari____Kari_source_Kari_Plugins_DataObject_DataObjectAnalyzer_14_46}
\inputminted[firstline=14, lastline=46]{cs}{../Kari/source/Kari.Plugins/DataObject/DataObjectAnalyzer.cs}

\section{DataObjectAnalyzer.cs, rândurile 48--157}\label{appendix:Kari____Kari_source_Kari_Plugins_DataObject_DataObjectAnalyzer_48_157}
\inputminted[firstline=48, lastline=157]{cs}{../Kari/source/Kari.Plugins/DataObject/DataObjectAnalyzer.cs}

\section{Program.cs}\label{appendix:uni_thesis____examples_dataobject_Program}
\inputminted{cs}{../examples/dataobject/Program.cs}

\section{DataObjects.cs}\label{appendix:uni_thesis____examples_dataobject_Generated_DataObjects}
\inputminted{cs}{../examples/dataobject/Generated/DataObjects.cs}

\section{setup.d}\label{appendix:race____race_dev_cli_source_commands_setup}
