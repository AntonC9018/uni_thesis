...
Deci a fost realizat un API declarativ pentru specificarea opțiunilor particulare care o clasă specifică va lua\footnote{a se vedea codul sursă pentru un exemplu complet:
